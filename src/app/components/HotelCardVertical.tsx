                    ...
                    <div className='flex flex-wrap justify-between items-end gap-2 text-xs py-4 font-sans capitalize font-semibold'>
                       ...
                       {/* modal space */}
                       {
                        ...
                        <div className='flex items-end gap-2'>
                            ...
                            <button disabled={true} title='currently this option is under maintanence, please click view details and book from there' className='text-sm para-text action-button transition active:scale-75 bg-slate-950 border-2 border-solid border-black text-white p-2 px-4 rounded-full disabled:cursor-not-allowed' onClick={openPaymentModal}>Book Now</button>
                        </div>
                    </div>
                </div>
            </div>
